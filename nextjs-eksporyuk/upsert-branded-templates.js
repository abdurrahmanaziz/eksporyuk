...
Silakan cek detail hasil penyelesaian.`,
  ...
  const PUSH = [
    ...
    // AFFILIATE
    template({ type: 'PUSH', name: 'PUSH • Komisi Masuk', category: 'AFFILIATE', subject: 'Komisi Baru Masuk', content: t`Jumlah: {commission}.`, ctaLink: '{links.affiliate}', tags: ['push','affiliate','commission'] }),
    template({ type: 'PUSH', name: 'PUSH • Withdrawal Disetujui', category: 'AFFILIATE', subject: 'Withdrawal Disetujui', content: t`Sedang diproses 1-3 hari.`, ctaLink: '{links.wallet}', tags: ['push','affiliate','withdrawal'] }),
