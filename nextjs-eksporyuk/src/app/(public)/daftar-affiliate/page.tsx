    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          {autoApproved ? (
            <>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">🎉 Selamat, Anda Sudah Jadi Affiliate!</h2>
              <p className="text-gray-600 mb-4">
                Aplikasi Anda langsung disetujui. Anda sudah bisa mulai mempromosikan produk!
              </p>
              {affiliateCode && (
          ...
          <div>
            <div className="mb-8">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Jadi Affiliate<br />
                <span className="text-orange-600">Eksporyuk</span>
              </h1>
                ...
                {step === 2 && (
                  <form onSubmit={handleFinalSubmit} className="space-y-4">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600">{session?.user ? 'Lengkapi data untuk menjadi affiliate' : 'Langkah 2: Data pembayaran'}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Ceritakan mengapa Anda ingin menjadi affiliate..."
                        rows={3}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                      />
                    </div>
