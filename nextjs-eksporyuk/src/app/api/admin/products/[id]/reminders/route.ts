...
// GET - Fetch reminders for product
...
// POST - Create new product reminder
export async function POST(
  ...
  try {
    ...
    const reminder = await prisma.productReminder.create({
      data: {
        productId: id,
        title: body.title,
    ...
    console.error('Error creating product reminder:', error)
