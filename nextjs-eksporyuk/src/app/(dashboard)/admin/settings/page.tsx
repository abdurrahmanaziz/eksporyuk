        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900">Tema & Warna</h2>
                <p className="text-sm text-gray-600">Konfigurasi warna utama website</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900">Pengaturan Tombol</h2>
                <p className="text-sm text-gray-600">Konfigurasi warna dan gaya tombol website</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <input
                    type="color"
                    value={settings.buttonSuccessText}
                    onChange={(e) => updateSetting('buttonSuccessText', e.target.value)}
                    className="w-16 h-12 border border-gray-300 rounded-lg cursor-pointer"
                  />
                  <input
                    type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <input
                    type="color"
                    value={settings.buttonDangerText}
                    onChange={(e) => updateSetting('buttonDangerText', e.target.value)}
                    className="w-16 h-12 border border-gray-300 rounded-lg cursor-pointer"
                  />
                  <input
                    type="text"
