  ...
  const fetchLesson = async () => {
    try {
      ...
      const lessonRes = await fetch(
        `/api/mentor/courses/${courseId}/modules/${moduleId}/lessons/${lessonId}`
      )
      ...
      const moduleRes = await fetch(
        `/api/mentor/courses/${courseId}/modules/${moduleId}`
      )
      if (moduleRes.ok) {
      ...
      // Fetch course info
      const courseRes = await fetch(`/api/mentor/courses/${courseId}`)
      if (courseRes.ok) {
