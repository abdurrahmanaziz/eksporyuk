...
export default function ApplyAffiliatePage() {
  ...
  const fetchAffiliateStatus = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // If already approved, redirect to affiliate dashboard
  ...
  if (!affiliateData?.affiliateMenuEnabled && session?.user?.role !== 'AFFILIATE') {
    return (
    ...
    <ResponsivePageWrapper>
      <div className="p-6 max-w-4xl mx-auto">
                ...
                <>
                  ...
                  <div>
                    ...
                    <p className="text-green-700">
                      Selamat! Anda sudah menjadi affiliate. Kode: <span className="font-mono font-bold">{affiliateData.affiliateCode}</span>
                    </p>
                    <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Benefits Section */}
          <div>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Keuntungan Menjadi Affiliate</h2>
