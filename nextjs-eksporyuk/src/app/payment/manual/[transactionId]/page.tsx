            ...
            <div className="space-y-3 pt-2">
              {details.contactInfo?.whatsapp ? (
                <a
                  ...
                  className="flex items-center justify-center w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-6 rounded-xl shadow-lg transition-all gap-3"
