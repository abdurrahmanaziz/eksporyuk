            ...
            <CardContent>
              {status === 'authenticated' ? (
                ...
                <>
                  ...
                  <div className="space-y-4 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-900 mb-4">
                    <div className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                      Daftar dengan cepat menggunakan akun Anda:
                    </div>
                    <Button
                      type="button"
                      variant="outline"
                      className="w-full h-11 border-2 border-blue-500 bg-white hover:bg-blue-50"
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-blue-50 dark:bg-blue-950/20 px-2 text-gray-600 dark:text-gray-400 font-medium">
                          atau
                        </span>
                      </div>
                    </div>
