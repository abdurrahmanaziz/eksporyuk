  ...
  try {
    ...
    const newCoupon = await prisma.coupon.create({
      data: {
        ...
        isActive: true,
        minPurchase: template.minPurchase || null,
        productIds: template.productIds || undefined,
        membershipIds: template.membershipIds || undefined,
        courseIds: template.courseIds || undefined,
