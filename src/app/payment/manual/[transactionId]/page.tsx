        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
          ...
          <div className="p-6 md:p-8 space-y-8">
            ...
            <div className="bg-slate-50 rounded-xl p-4 border border-slate-100">
              ...
              <ol className="space-y-2 text-sm text-slate-600">
                ...
                <li className="flex gap-2">
                  ...
                  <span>Upload bukti transfer atau konfirmasi via WhatsApp.</span>
                </li>
              </ol>
            </div>
            ...
            <div className="space-y-3 pt-2">
              {/* Upload Bukti Transfer Button - Primary Action */}
              <button
                onClick={() => router.push(`/confirm/${details.transactionId}`)}
                className="flex items-center justify-center w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-6 rounded-xl shadow-lg transition-all gap-3"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
                <span className="text-lg">Upload Bukti Transfer</span>
              </button>
              
              {/* WhatsApp Confirmation - Secondary Action */}
              {details.contactInfo?.whatsapp ? (
                <a
                  href={`https://wa.me/${details.contactInfo.whatsapp}?text=${generateWhatsAppMessage()}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-xl transition-all gap-3"
